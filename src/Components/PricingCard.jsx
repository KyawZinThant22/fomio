  ...
  return (
    <div className={` ${color} md:w-[500px] ${textColor} border-y-4 border-solid ${card.borderColor}  sm:w-[400px]  xs:mx-4 sm:mx-auto lg:mx-0 p-8 rounded-[5px]  priceCard lg:${card.height} `} >
      <div className="text-center space-y-6">
        ...
        <h1 className={`text-5xl font-extrabold`}>&#36;{card.price} <span className="text-4xl font-light">/proj</span> </h1>
        <p className={` mx-auto leading-[30px] text-xl`}  >{card.body}</p>
        <button className="border-solid border-[2px] border-dark p-3 px-8  hover:text-primaryDark   rounded-[5px]">Get Started</button>
      </div>
