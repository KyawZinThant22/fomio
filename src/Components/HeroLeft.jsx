...
const HeroLeft = () => {
  return (
    <div className="mt-12 md:inline-block flex flex-col items-center">
      <h1 className="text-primary hidden  md:text-[40px] md:block text-[60px] md:-mr-[7rem] font-bold md:leading-[50px] leading-[88px]">
    ...
    {/* for mobile */}
      ...
      <p className="text-white md:w-[650px]  w-[21rem] text-[15px] md:leading-[30px] md:text-lg mt-5 md:mt-12">
